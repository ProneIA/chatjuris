...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('Enviando email direto via Core.SendEmail...');
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Todos os templates de email estão configurados e prontos para enviar notificações automáticas aos clientes do Juris Pro.</p>
            </div>
            <div class="footer">
    ...
    console.log('✅ Email de teste enviado com sucesso para ld.andrade@outlook.com');

    return Response.json({ 
      success: true,
      message: 'Email enviado com sucesso para ld.andrade@outlook.com!'
    }, { headers });
