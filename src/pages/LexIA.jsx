...
const MONTHLY_PLANS = [
  ...
  },
  {
    ...
    featured: false,
    badge: null,
    tagline: "Para escritórios e equipes",
    features: [
      "Usuários ilimitados",
      "Documentos ilimitados",
...
const ANNUAL_PLANS = [
  {
    ...
    badge: null,
    savings: "R$ 240,00",
    tagline: "R$ 59/mês — economize R$ 240",
    features: [
      "1 usuário",
      "50 documentos por mês",
      "Assistente jurídico IA",
  ...
  },
  {
    ...
    savings: "R$ 360,00",
    tagline: "R$ 119/mês — economize R$ 360",
    features: [
      "Até 3 usuários",
      "Documentos ilimitados",
      "Portal do cliente",
  ...
  },
  {
    ...
    savings: "R$ 480,00",
    tagline: "R$ 259/mês — economize R$ 480",
    features: [
      "Usuários ilimitados",
      "Documentos ilimitados",
      "Relatórios avançados",
