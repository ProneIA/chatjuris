...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-slate-200 z-50">
        <div className="h-full px-4 flex items-center justify-between">
          ...
          >
            ...
            <span className="font-bold text-slate-900 text-sm">Juris IA</span>
          </Link>
          ...
          <div className="flex items-center gap-1">
            ...
            <Link
              ...
              className="p-1.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg hover:opacity-90 transition-opacity"
            >
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed top-14 left-0 bottom-0 w-64 bg-white border-r border-slate-200 z-40 overflow-y-auto"
            >
      ...
      {/* Main Content */}
      <main className={`min-h-screen ${isOnAIPage ? '' : 'pt-14 lg:pt-0 lg:pl-64'}`}>
        {children}
      </main>
    </div>
  );
