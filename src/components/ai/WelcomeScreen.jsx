...
import { Sparkles, MessageSquare, FileText, Scale, Brain, Search } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    description: "Pesquise jurisprudência dos principais tribunais"
  }
];
...
const examples = [
  ...
  { icon: Search, text: "Buscar jurisprudência" }
];
